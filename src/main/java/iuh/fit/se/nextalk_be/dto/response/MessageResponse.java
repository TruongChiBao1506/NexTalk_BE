...
public class MessageResponse {
    ...
    /**
     * Correlation id generated by the sending client.  It is also kept in
     * metadata for backwards compatibility, but exposing it explicitly makes
     * optimistic-message reconciliation part of the realtime API contract.
     */
